...
Write-GoldISOLog -Message "  WinPE Image Apply Tool                                       " -Level "INFO"
Write-GoldISOLog -Message "---------------------------------------------------------------" -Level "INFO"
Write-Host ""
...
Write-GoldISOLog -Message "`n[Step 1] Locating WIM image..." -Level "INFO"
...
Write-GoldISOLog -Message "`n[Step 2] Preparing target disk..." -Level "INFO"
...
Write-GoldISOLog -Message "`n[Step 3] Applying image..." -Level "INFO"
...
try {
    ...
    Write-GoldISOLog -Message "`n[Step 4] Copying unattend.xml..." -Level "INFO"
...
Write-GoldISOLog -Message "`n[Step 4] Configuring boot..." -Level "INFO"
...
if ($partitions.Recovery) {
    Write-GoldISOLog -Message "`n[Step 5] Configuring recovery partition..." -Level "INFO"
...
Write-GoldISOLog -Message "`n---------------------------------------------------------------" -Level "SUCCESS"
Write-GoldISOLog -Message "  IMAGE APPLY COMPLETE                                         " -Level "SUCCESS"
Write-GoldISOLog -Message "---------------------------------------------------------------" -Level "SUCCESS"
Write-GoldISOLog -Message "Source Image:  $ImagePath" -Level "INFO"
Write-GoldISOLog -Message "Target Disk:   Disk $TargetDisk" -Level "INFO"
Write-GoldISOLog -Message "Windows Drive: $windowsDrive" -Level "INFO"
Write-GoldISOLog -Message "Boot Mode:     $detectedBootMode" -Level "INFO"
Write-GoldISOLog -Message "Duration:      $([math]::Round($duration.TotalMinutes, 2)) minutes" -Level "INFO"
Write-GoldISOLog -Message "---------------------------------------------------------------" -Level "SUCCESS"
Write-GoldISOLog -Message "`nSystem ready to boot. Remove WinPE media and restart." -Level "SUCCESS"
